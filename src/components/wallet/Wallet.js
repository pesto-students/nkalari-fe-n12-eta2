        ...
        <div class="flex flex-col space-y-8">
                    ...
                    <div class="flex flex-col space-y-6 md:h-full md:justify-between">
                        ...
                        <div class="flex gap-2 md:gap-4 justify-between items-center">
                            <div class="flex flex-col space-y-4">
                                <h2 class="text-white font-bold tracking-widest leading-tight"> Jagan's Account</h2>
                                <div class="flex items-center gap-4">
                                    <p class="text-lg text-white tracking-wider">**** **** *321</p>
                            ...
                            <h2 class="text-lg md:text-xl xl:text-3xl text-white font-black tracking-wider">
                                <span class="md:text-xl"><img src={Diamonds}></img></span>
                                92,817
                            </h2>
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 items-start px-4 xl:p-0 gap-y-4 md:gap-6">
                <div class="col-start-1 col-end-5">
                    <h2 class="text-xs md:text-sm text-white font-bold tracking-wide">Summary Transactions</h2>
                </div>
                ...
                <div class="col-span-3 bg-gray-800 bg-opacity-60 p-6 rounded-xl  flex flex-col">
                    <div class="flex justify-between items-center">
                        <h2 class="text-sm text-white font-bold tracking-wide">Latest Transactions</h2>
