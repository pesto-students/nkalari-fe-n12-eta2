    ...
    <div className="bg-[url('https://source.unsplash.com/T9OjDl5SbcM/1920x1280')]">
      ...
      <div id="product">
        <div
          ...
          className="flex flex-col items-center justify-start font-sans min-h-96 lg:pt-10 lg:pb-20 shadow-lg	lg:bg-hero lg:bg-cover"
        >
          <div>
            <p className="p-3 pt-12 text-lg font-bold text-white lg:text-white">
              {appType}
            </p>
          </div>
          <div>
        ...
        <div className="z-0 flex flex-row items-start justify-center w-screen h-screen pt-20 -mb- bg-gray-50 lg:bg-white lg:mb-0 lg:w-full lg:h-96 lg:pt-0">
          <img
            className="absolute left-0 lg:left-auto  lg:mr-72 lg:-mt-72"
            src={rectangle_1}
            alt=""
          />
          <img
            className="absolute right-0 lg:right-auto lg:ml-72 lg:-mt-64"
            src={rectangle_2}
            alt=""
          />
        </div>
