    ...
    <div className="flex flex-row items-center justify-between h-28">
      <a href="/" className="pl-7 logo lg:ml-10">
        <img height="35%" width="35%" src={logo} alt="logo" />
             ...
             openNav &&
              <div ref={wrapperRef} className="absolute top-0 w-full h-48 bg-white">
                ...
                <div className="flex flex-col items-center justify-around h-full pt-5">
                  <a onClick={()=>setOpenNav(false)} href="/" className="text-lg font-semibold text-white transition-all hover:text-orange-500">Home</a>
                  <a onClick={()=>setOpenNav(false)} href="/Login" className="text-lg font-semibold text-white transition-all hover:text-orange-500">Login</a>
                </div>
              </div>
          }
          ...
          <div className="flex justify-around w-1/6 mr-2  lg:visible sm:invisible">
              <a href="#home" className="text-lg font-semibold text-white transition-all hover:text-orange-500">Home</a>
              <a href="/login" className="text-lg font-semibold text-white transition-all hover:text-orange-500">Login</a>
