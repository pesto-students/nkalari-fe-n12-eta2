...
function Navbar() {
    ...
    return (
        ...
        <div class="min-h-screen flex flex-row bg-gray-100">
          <div class="flex flex-col w-20 bg-white rounded-r-3xl overflow-hidden">
          <img src={home}class="items-center w-15 h-15 transform hover:translate-x-2 transition-transform ease-in duration-200 "></img>
          <img src={wallet}></img>
          <img src={profile}></img>
