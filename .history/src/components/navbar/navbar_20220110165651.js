...
function Navbar() {
    ...
    return (
        ...
        <div class="min-h-screen flex flex-row bg-gray-100">
          ...
          <img src={home}class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800"></img>
          <img src={wallet}></img>
          <img src={profile}></img>
