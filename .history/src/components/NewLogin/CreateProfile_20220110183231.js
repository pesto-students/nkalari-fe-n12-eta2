...
function CreateUserScreen(props) {
  ...
  function fullNameIsValid(fullName) {
    if (fullName == undefined || fullName == '') {
      setMobileError("Must enter a Full Name")
    } else {
      setMobileError('')
      return true
    }
  ...
  function handleSubmit(e) {
    ...
    fullNameValid = fullNameIsValid(mobile)
      ...
      <h2>Create your Profile here</h2>
        ...
        <div id="sign-in-button" ></div>
          <div className="form-group">
            <input onChange={e => setFullName(e.target.value)} name="mobile" placeholder="Full Name" type="text"/>
